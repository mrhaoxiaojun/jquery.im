...
// 测试
// kj7swf8o7vcp2
// {"code":200,"userId":"U1111","token":"AN59hhQAlivWEXMhtrdC2JxDrgfEENETYoMmRK9bW/S7L5MNPIaZEgbi3czaFl4tIQ5fLbWS82+kD/PSoZo5cA=="}
;
(function($, window) {
    $(function() {
        var chart = {
            ...
            init: function() {
                ...
                var token = "qmNXHKMa7PIfID6ImHAqSl/6VTlV7ddnkHyghYrMJXTZMNMvM5uu4u79QSeT3IEdb5Bdhw+ijUc=";
            ...
            connectServer: function(token) {
                ...
                RongIMClient.connect(token, {
                    onSuccess: function(userId) {
                        ...
                        //链接成功取，用户自己的 , id ,用户名，icon，公司名称
                        that.selfId = userId;
                        that.selfName = "郝小军";
                        that.selfIcon = ""
                        that.selfCompany = "乐视集团"
